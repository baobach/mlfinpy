...
def _get_values_diff(test_type: str, series: pd.Series, index: pd.Index, ind: pd.Index) -> float:
    """
    ...
    ----------
    test_type : str
        Type of the test. Can be either 'one_sided' or 'two_sided'.
    series : pd.Series
        Series of values.
    index : pd.Index
        Primary index.
