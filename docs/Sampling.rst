...
assume that samples are `Independent and Identically Distributed`_ (I.I.D), in the case of financial machine learning samples are 
neither identically distributed nor independent. In this section we will tackle the problem of samples dependency.

As mentioned in the literature, we use :ref:`labelling-tb_meta`_ to label the structured financial data. Each label in triple-barrier event
...
.. _Independent and Identically Distributed: https://en.wikipedia.org/wiki/Independent_and_identically_distributed_random_variables
...
For performance increase I've optimized and parallesied for-loop using numba, which corresponds to ``bootstrap_loop_run`` function.
...
.. code-block:: python
    ...
    prob_array
    >>> array([0.35714285714285715, 0.21428571428571427, 0.42857142857142855], dtype=object)
...
.. code-block:: python
    ...
    prob_array
    >>> array([0.45454545454545453, 0.2727272727272727, 0.2727272727272727], dtype=object)
...
.. code-block:: python
    ...
    prob_array
    >>> array([0.32653061224489793, 0.3061224489795918, 0.36734693877551017], dtype=object)
