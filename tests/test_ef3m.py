...
class TestM2NMpFit(unittest.TestCase):
    ...
    def test_mp_fit_return_type(self):
        ...
        max_iter_test = 10_000
        num_workers_test = 1
        epsilon_test, factor_test, n_runs_test, variant_test, max_iter_test, num_workers_test = (
            1e-5,
            5,
            10,
            2,
        ...
        m2n_test = M2N(
            moments_test, epsilon_test, factor_test, n_runs_test, variant_test, max_iter_test, num_workers_test
        )
...
class TestMostLikelyParameters(unittest.TestCase):
    ...
    def test_most_likely_parameters_result(self):
        ...
        df_test = pd.DataFrame.from_dict(
            {"mu_1": mu_1_list, "mu_2": mu_2_list, "sigma_1": sigma_1_list, "sigma_2": sigma_2_list, "p_1": p_1_list}
        )
        most_likely_correct = {"mu_1": -2.03765, "mu_2": 1.00863, "sigma_1": 1.9832, "sigma_2": 1.00012, "p_1": 0.09942}
