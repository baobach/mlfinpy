...
from mlfinpy.data_structure import run_bars as ds
...
class TestDataStructures(unittest.TestCase):
    ...
    def test_ema_run_dollar_bars(self):
        ...
        db3, _ = ds.get_ema_dollar_run_bars(
            self.path,
            exp_num_ticks_init=exp_num_ticks_init,
            expected_imbalance_window=10000,
            num_prev_bars=num_prev_bars,
    ...
    def test_ema_run_volume_bars(self):
        ...
        db1, thresh_1 = ds.get_ema_volume_run_bars(
            self.path,
            exp_num_ticks_init=exp_num_ticks_init,
            expected_imbalance_window=10000,
            num_prev_bars=num_prev_bars,
        ...
        db2, thresh_2 = ds.get_ema_volume_run_bars(
            self.path,
            exp_num_ticks_init=exp_num_ticks_init,
            expected_imbalance_window=10000,
            num_prev_bars=num_prev_bars,
        ...
        db3, _ = ds.get_ema_volume_run_bars(
            self.path,
            exp_num_ticks_init=exp_num_ticks_init,
            expected_imbalance_window=10000,
            num_prev_bars=num_prev_bars,
    ...
    def test_ema_run_tick_bars(self):
        ...
        db1, thresh_1 = ds.get_ema_tick_run_bars(
            self.path,
            exp_num_ticks_init=exp_num_ticks_init,
            expected_imbalance_window=10000,
            num_prev_bars=num_prev_bars,
        ...
        db2, thresh_2 = ds.get_ema_tick_run_bars(
            self.path,
            exp_num_ticks_init=exp_num_ticks_init,
            expected_imbalance_window=10000,
            num_prev_bars=num_prev_bars,
        ...
        db3, _ = ds.get_ema_tick_run_bars(
            self.path,
            exp_num_ticks_init=exp_num_ticks_init,
            expected_imbalance_window=10000,
            num_prev_bars=num_prev_bars,
    ...
    def test_ema_run_dollar_bars_with_constraints(self):
        ...
        db1, _ = ds.get_ema_dollar_run_bars(
            self.path,
            exp_num_ticks_init=exp_num_ticks_init,
            expected_imbalance_window=10000,
        ...
        db2, _ = ds.get_ema_dollar_run_bars(
            self.path,
            exp_num_ticks_init=exp_num_ticks_init,
            expected_imbalance_window=10000,
            exp_num_ticks_constraints=exp_num_ticks_constraints,
    ...
    def test_const_run_dollar_bars(self):
        ...
        db1, thresh_1 = ds.get_const_dollar_run_bars(
            self.path,
            exp_num_ticks_init=exp_num_ticks_init,
            expected_imbalance_window=10000,
            num_prev_bars=num_prev_bars,
        ...
        db2, thresh_2 = ds.get_const_dollar_run_bars(
            self.path,
            exp_num_ticks_init=exp_num_ticks_init,
            expected_imbalance_window=10000,
            num_prev_bars=num_prev_bars,
        ...
        db3, _ = ds.get_const_dollar_run_bars(
            self.path,
            exp_num_ticks_init=exp_num_ticks_init,
            expected_imbalance_window=10000,
            num_prev_bars=num_prev_bars,
    ...
    def test_const_run_volume_bars(self):
        ...
        db1, thresh_1 = ds.get_const_volume_run_bars(
            self.path,
            exp_num_ticks_init=exp_num_ticks_init,
            expected_imbalance_window=10000,
            num_prev_bars=num_prev_bars,
        ...
        db2, thresh_2 = ds.get_const_volume_run_bars(
            self.path,
            exp_num_ticks_init=exp_num_ticks_init,
            expected_imbalance_window=10000,
            num_prev_bars=num_prev_bars,
        ...
        db3, _ = ds.get_const_volume_run_bars(
            self.path,
            exp_num_ticks_init=exp_num_ticks_init,
            expected_imbalance_window=10000,
            num_prev_bars=num_prev_bars,
    ...
    def test_const_run_tick_bars(self):
        ...
        db1, thresh_1 = ds.get_const_tick_run_bars(
            self.path,
            exp_num_ticks_init=exp_num_ticks_init,
            expected_imbalance_window=10000,
            num_prev_bars=num_prev_bars,
        ...
        db2, thresh_2 = ds.get_const_tick_run_bars(
            self.path,
            exp_num_ticks_init=exp_num_ticks_init,
            expected_imbalance_window=10000,
            num_prev_bars=num_prev_bars,
        ...
        db3, _ = ds.get_const_tick_run_bars(
            self.path,
            exp_num_ticks_init=exp_num_ticks_init,
            expected_imbalance_window=10000,
            num_prev_bars=num_prev_bars,
    ...
    def test_csv_format(self):
        ...
        self.assertRaises(ValueError, ds.BaseRunBars._assert_csv, pd.DataFrame(wrong_date).T)
        # pylint: disable=protected-access
        self.assertRaises(AssertionError, ds.BaseRunBars._assert_csv, pd.DataFrame(too_many_cols).T)
        # pylint: disable=protected-access
        self.assertRaises(AssertionError, ds.BaseRunBars._assert_csv, pd.DataFrame(wrong_price).T)
        # pylint: disable=protected-access
        self.assertRaises(AssertionError, ds.BaseRunBars._assert_csv, pd.DataFrame(wrong_volume).T)
